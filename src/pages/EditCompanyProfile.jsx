      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="md:col-span-2 space-y-4">
          <div className="bg-white rounded-xl border border-border p-4 sm:p-5">
            <div className="flex gap-0.5 sm:gap-1 mb-4 sm:mb-5 border-b border-border-soft -mx-4 sm:-mx-5 px-4 sm:px-5 overflow-x-auto">
              {TABS.map((tabKey) => (
                <button key={tabKey} onClick={() => setTab(tabKey)}
                  className={`px-2.5 sm:px-3 py-2.5 text-xs sm:text-sm font-medium border-b-2 -mb-px transition-colors whitespace-nowrap ${
